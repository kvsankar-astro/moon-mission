...
const missionStateCells = createMissionLegacyStateCells({
    localStateBindings: {
        globalConfig: { get: () => globalConfig, set: (value) => { globalConfig = value; } },
        svgContainer: { get: () => svgContainer, set: (value) => { svgContainer = value; } },
        dataLoaded: { get: () => dataLoaded, set: (value) => { dataLoaded = value; } },
        svgX: { get: () => svgX, set: (value) => { svgX = value; } },
        svgY: { get: () => svgY, set: (value) => { svgY = value; } },
        svgWidth: { get: () => svgWidth, set: (value) => { svgWidth = value; } },
        svgHeight: { get: () => svgHeight, set: (value) => { svgHeight = value; } },
        offsetx: { get: () => offsetx, set: (value) => { offsetx = value; } },
        offsety: { get: () => offsety, set: (value) => { offsety = value; } },
        landingDataLoaded: { get: () => landingDataLoaded, set: (value) => { landingDataLoaded = value; } },
        epochJD: { get: () => epochJD, set: (value) => { epochJD = value; } },
        epochDate: { get: () => epochDate, set: (value) => { epochDate = value; } },
        startTime: { get: () => startTime, set: (value) => { startTime = value; } },
        endTime: { get: () => endTime, set: (value) => { endTime = value; } },
        endTimeSC: { get: () => endTimeSC, set: (value) => { endTimeSC = value; } },
        latestEndTime: { get: () => latestEndTime, set: (value) => { latestEndTime = value; } },
        timelineTotalSteps: { get: () => timelineTotalSteps, set: (value) => { timelineTotalSteps = value; } },
        ticksPerAnimationStep: { get: () => ticksPerAnimationStep, set: (value) => { ticksPerAnimationStep = value; } },
        PIXELS_PER_AU: { get: () => PIXELS_PER_AU, set: (value) => { PIXELS_PER_AU = value; } },
        defaultCameraDistance: { get: () => defaultCameraDistance, set: (value) => { defaultCameraDistance = value; } },
        trackWidth: { get: () => trackWidth, set: (value) => { trackWidth = value; } },
        earthRadius: { get: () => earthRadius, set: (value) => { earthRadius = value; } },
        moonRadius: { get: () => moonRadius, set: (value) => { moonRadius = value; } },
        startLandingTime: { get: () => startLandingTime, set: (value) => { startLandingTime = value; } },
        endLandingTime: { get: () => endLandingTime, set: (value) => { endLandingTime = value; } },
        craftData: { get: () => craftData, set: (value) => { craftData = value; } },
        eventInfos: { get: () => eventInfos, set: (value) => { eventInfos = value; } },
        ephemerisSource: { get: () => ephemerisSource, set: (value) => { ephemerisSource = value; } },
        bodyEphemerisSources: { get: () => bodyEphemerisSources, set: (value) => { bodyEphemerisSources = value; } },
        timeTransLunarInjection: { get: () => timeTransLunarInjection, set: (value) => { timeTransLunarInjection = value; } },
        timeLunarOrbitInsertion: { get: () => timeLunarOrbitInsertion, set: (value) => { timeLunarOrbitInsertion = value; } },
        theSceneHandler: { get: () => theSceneHandler, set: (value) => { theSceneHandler = value; } },
        animDate: { get: () => animDate, set: (value) => { animDate = value; } },
        svgRect: { get: () => svgRect, set: (value) => { svgRect = value; } },
        sunLongitude: { get: () => sunLongitude, set: (value) => { sunLongitude = value; } },
    },
