...
function createMissionLegacyState({
    ...
    return {
        ...
        craftId: "SC",
        config: getDefaultOriginKey(),
        missionStartCalled: false,
        orbitDataLoaded: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
        orbitDataProcessed: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
        orbitData: {},
        ...
        chebyshevDataLoaded: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
        chebyshevData: {},
        npzDataLoaded: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
        npzData: {},
        landingNpzLoaded: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
        landingNpzData: {},
        landingChebyshevLoaded: buildOriginFlagMap(DEFAULT_ORIGIN_KEYS, false),
